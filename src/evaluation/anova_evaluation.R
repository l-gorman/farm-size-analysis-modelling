...
bayesplot::mcmc_scatter(adm0_anova,
                        pars=c("b_Intercept",
...
bayesplot::mcmc_scatter(adm0_adm_1_adm_2_anova,
                        pars=c("sd_ADM0_NAME:ADM1_CODE__Intercept",
                               "sd_ADM0_NAME__Intercept"))
...
bayesplot::mcmc_scatter(adm0_adm_1_adm_2_village_anova,
                        pars=c("sd_ADM0_NAME:ADM1_CODE__Intercept",
                               "sd_ADM0_NAME__Intercept"))
...
bayesplot::mcmc_scatter(adm_0_adm_2_village_anova,
...
# LOO  ----------------------------------------------------------
adm0_anova <- add_criterion(adm0_anova, "loo",moment_match = TRUE)
adm0_adm_1_anova <- add_criterion(adm0_adm_1_anova, "loo",moment_match = TRUE)
adm0_adm_1_adm_2_anova <-  add_criterion(adm0_adm_1_adm_2_anova, "loo",moment_match = TRUE)
adm_0_adm_2_village_anova <-  add_criterion(adm_0_adm_2_village_anova, "loo",moment_match = TRUE)
adm0_adm_1_adm_2_village_anova <-  add_criterion(adm0_adm_1_adm_2_village_anova, "loo",moment_match = TRUE)

loo_compare(adm0_anova, adm0_adm_1_anova, adm0_adm_1_adm_2_anova, adm0_adm_1_adm_2_village_anova,adm_0_adm_2_village_anova,criterion = c("loo"), model_names = NULL)
...
load("./outputs/brms_anova/multi_level_normal_random_error/adm0_anova.rda")
summary(adm0_anova)


load("./outputs/brms_anova/multi_level_normal_random_error/adm0_adm_1_anova.rda")
summary(adm0_adm_1_anova)

load("./outputs/brms_anova/multi_level_normal_random_error/adm0_adm_1_adm_2_anova.rda")
summary(adm0_adm_1_adm_2_anova)

load("./outputs/brms_anova/multi_level_normal_random_error/adm0_adm_1_adm_2_village_anova.rda")
summary(adm0_adm_1_adm_2_village_anova)




# Modelling and plotting Errors too ---------------------------------------



load("./outputs/brms_anova/multi_level_normal_random_error/adm_0_adm_2_village_anova.rda")
summary(adm_0_adm_2_village_anova)
get_variables(adm_0_adm_2_village_anova)[1:12]
...
bayesplot::mcmc_intervals(posterior,
                          pars = c("b_Intercept", "sd_ADM0_NAME__Intercept","sd_ADM0_NAME:ADM2_CODE__Intercept","sd_ADM0_NAME:ADM2_CODE:village__Intercept"))
...
bayesplot::mcmc_scatter(adm_0_adm_2_village_anova,
                        pars=c("sd_ADM0_NAME__sigma_Intercept",
                               "sd_ADM0_NAME:ADM2_CODE__sigma_Intercept"))

bayesplot::mcmc_scatter(adm_0_adm_2_village_anova,
                        pars=c("sd_ADM0_NAME__sigma_Intercept",
                               "sd_ADM0_NAME:ADM2_CODE:village__sigma_Intercept"))

bayesplot::mcmc_scatter(adm_0_adm_2_village_anova,
                        pars=c("sd_ADM0_NAME:ADM2_CODE__sigma_Intercept",
                               "sd_ADM0_NAME:ADM2_CODE:village__sigma_Intercept"))
